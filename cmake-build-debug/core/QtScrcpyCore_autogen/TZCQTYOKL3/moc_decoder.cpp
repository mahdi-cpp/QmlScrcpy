...
#include "../../../../core/src/device/decoder/decoder.h"
...
QT_MOC_LITERAL(1, 8, 9), // "updateFPS"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 3), // "fps"
QT_MOC_LITERAL(4, 23, 8), // "newFrame"
QT_MOC_LITERAL(5, 32, 10) // "onNewFrame"

    },
    "Decoder\0updateFPS\0\0fps\0newFrame\0"
    "onNewFrame"
};
...
void Decoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Decoder::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Decoder::updateFPS)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Decoder::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Decoder::newFrame)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Decoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Decoder.data,
      qt_meta_data_Decoder,  qt_static_metacall, nullptr, nullptr}
};
